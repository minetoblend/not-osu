...
namespace osu.Game.Rulesets.NotOsu.Beatmaps
{
    public class NotOsuBeatmapConverter : BeatmapConverter<NotOsuHitObject>
    {
        public NotOsuBeatmapConverter(IBeatmap beatmap, Ruleset ruleset)
